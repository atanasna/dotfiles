...
// const vec4 TRAIL_COLOR = vec4(0.788, 1.0, 0.996, 1.0);
const vec4 TRAIL_COLOR = vec4(1.0, 1.0, 1.0, 0.001);
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
// const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 0., 0., 1.0); // red-orange
// const vec4 TRAIL_COLOR_ACCENT = vec4(0.243, 0.941, 0.824, 0.5);
const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 1.0, 1.0, 0.001);
